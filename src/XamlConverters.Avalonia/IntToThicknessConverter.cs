...
public sealed class IntToThicknessConverter : IValueConverter
{
    ...
    /// <summary>Gets or sets a value indicating whether the bottom side is replaced.</summary>
    public bool Bottom { get; set; }

    /// <summary>Gets or sets a value indicating whether the left side is replaced.</summary>
    public bool Left { get; set; }

    /// <summary>Gets or sets a value indicating whether the right side is replaced.</summary>
    public bool Right { get; set; }

    /// <summary>Gets or sets a value indicating whether the top side is replaced.</summary>
