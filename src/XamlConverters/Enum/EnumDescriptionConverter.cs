...
/// <summary>
/// Converts enum members to and from their <see cref="DescriptionAttribute.Description"/> text.
/// </summary>
public sealed class EnumDescriptionConverter : IValueConverter
{
    /// <summary>
    /// Returns an enum member's description, falling back to its member name.
    /// </summary>
    ...
    /// <summary>
    /// Finds an enum member by description or member name.
    /// </summary>
