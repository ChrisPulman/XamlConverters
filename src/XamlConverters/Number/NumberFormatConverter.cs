...
/// <summary>
/// Formats any built-in numeric value and parses the result back to the requested numeric type.
/// </summary>
public sealed class NumberFormatConverter : IValueConverter
{
    /// <summary>
    /// Formats a number using the optional standard or custom numeric format in the converter parameter.
    /// </summary>
    ...
    {
        if (value == null || !BclConversion.IsNumericType(value.GetType()) || value is not IFormattable formattable)
        {
    ...
    /// <summary>
    /// Parses formatted text back to the requested numeric source type.
    /// </summary>
