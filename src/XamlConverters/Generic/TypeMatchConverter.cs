...
/// <summary>
/// Determines whether the bound value is assignable to a requested type.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Tests the runtime type of the supplied value.
    /// </summary>
    ...
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        {
            return value != null && expectedType.IsInstanceOfType(value);
        }
