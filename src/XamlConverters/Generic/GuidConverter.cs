...
/// <summary>
/// Converts between <see cref="Guid"/>, its textual representation, and a 16-byte array.
/// </summary>
public sealed class GuidConverter : IValueConverter
{
    /// <summary>
    /// Converts a GUID to text or converts text/bytes to a GUID according to the target type.
    /// </summary>
    ...
    /// <summary>
    /// Converts a target representation back to the requested GUID, string, or byte-array source type.
    /// </summary>
