...
/// <summary>Tests common WPF visibility conversions.</summary>
public class VisibilityConverterTests
{
    /// <summary>The invariant culture used by converter tests.</summary>
    private static readonly CultureInfo InvariantCulture = CultureInfo.InvariantCulture;

    /// <summary>Inverts visible, collapsed, and hidden values.</summary>
    ...
    /// <summary>Maps nullability to visibility with optional reversal.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
