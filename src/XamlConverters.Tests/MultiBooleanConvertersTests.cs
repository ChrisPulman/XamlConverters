...
/// <summary>Tests multi-value Boolean converters.</summary>
public class MultiBooleanConvertersTests
{
    /// <summary>Ands all true returns true.</summary>
    ...
    /// <summary>Ands the one false returns false.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Ors any true returns true.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Ors all false returns false.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Xors the odd true returns true.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Xors the single true returns true.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
